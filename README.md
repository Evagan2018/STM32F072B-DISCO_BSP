...
This is the development repository for the **STMicroelectronics STM32F072B-DISCO Board Support Pack (BSP)** - a CMSIS software pack that is designed to work with all compiler toolchains (Arm Compiler, GCC, IAR, LLVM). It is released as [CMSIS software pack](https://www.keil.arm.com/packs/stm32f072b-disco_bsp-keil) and therefore accessible by CMSIS-Pack enabled software development tools.
...
[.github/workflows](https://github.com/Open-CMSIS-Pack/STM32F072B-DISCO_BSP/tree/main/.github/workflows) | [GitHub Actions](#github-actions) scripts described below.
[CMSIS/Driver](https://github.com/Open-CMSIS-Pack/STM32F072B-DISCO_BSP/tree/main/CMSIS/Driver)           | Contains a [CMSIS-Driver VIO](https://arm-software.github.io/CMSIS_6/latest/Driver/group__vio__interface__gr.html) that is configured for the board peripherals.
[Documents](https://github.com/Open-CMSIS-Pack/STM32F072B-DISCO_BSP/tree/main/Documents)                 | [Usage overview](https://github.com/Open-CMSIS-Pack/STM32F072B-DISCO_BSP/tree/main/Documents/OVERVIEW.md) for examples and board documentation provided by STMicroelectronics.
...
This development repository can be used in a local directory and [mapped as software pack](https://open-cmsis-pack.github.io/cmsis-toolbox/build-tools#install-a-repository) using for example `cpackget` with:
    ...
    cpackget add <path>/Keil.STM32F072B-DISCO_BSP.pdsc
...
Please feel free to raise an [issue on GitHub](https://github.com/Open-CMSIS-Pack/STM32F072B-DISCO_BSP/issues)
